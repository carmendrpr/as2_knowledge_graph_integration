...
class ReadMyGraph(RclNode):
    def __init__(self):
        ...
        Clients
        """
        self.client_nodes = self.create_client(ReadGraph, '/read_graph')
    ...
    def read_graph(self):
        ...
        #     self.responses.update({'nodes': self.client_nodes.call_async(req_nodes.node_class)})
        #     print(self.responses.get('nodes'))
        if self.resp is None:
            self.resp = self.client_nodes.call_async()
